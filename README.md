...
## 0.download_data
This folder contains the code and metadata to download the plate data. The structure is as follows:
- jump_dataset.csv
    - This dataset contains the aws s3 links to each of the plates, speficied as rows. These links were acquired by modifying the source path of the sqlite files by:
