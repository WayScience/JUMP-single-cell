...
Random sampling of control cells is done through stratification by plate well.
...
The analysis scripts in this directory include plate-level and treatment-level aggregation, significance testing, and probability distribution visualization.
