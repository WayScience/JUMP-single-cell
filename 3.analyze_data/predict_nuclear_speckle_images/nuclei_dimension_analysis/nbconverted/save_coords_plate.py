...
# # Compute Plate Crop Dimension Data
...
for i, batch in enumerate(
    ...
    plate_dimensions_data_path = (
        ...
        / f"{metadata_path.stem}_nuclei_crop_dimensions_{i:02d}.parquet"
    )
