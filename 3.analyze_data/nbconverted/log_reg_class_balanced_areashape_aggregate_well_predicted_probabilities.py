...
comparison_results_output_filename = "class_balanced_well_log_reg_areashape_aggregate_probabilities.parquet"
output_path = pathlib.Path("class_balanced_well_log_reg_aggregate_probabilities")
...
def perform_aggregation(_dmso_probs, _treatment_probs):
    """
    Parameters
    ----------
    _dmso_probs: pandas.Series
        The down-sampled predicted probilities of DMSO for a treatment type and phenotype (not used).
...
comp_functions = {"median_aggregated":  # Name of the test to perform
                  {"statistical_test_function": perform_aggregation,  # The function for making comparisons
                   "comparison_metric": "median_aggregated"}  # The name of the comparison metric
                  }
